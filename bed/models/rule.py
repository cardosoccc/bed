...
class Rule(Base):
    ...
    min_proportion: Mapped[float | None] = mapped_column(Numeric(precision=5, scale=2), nullable=True)
    max_proportion: Mapped[float | None] = mapped_column(Numeric(precision=5, scale=2), nullable=True)
